...
// Đây là đối tượng giúp phát hiện các thay đổi hướng màn hình và khóa hướng màn hình khi ứng dụng đang chạy
...
const GameScreen = props => {
  // Khi vào màn hình GameScreen thì phone sẽ đổi đang chiều dọc
